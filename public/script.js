mapboxgl.accessToken =
	"pk.eyJ1IjoiYWxhc3RhaXJ0ZWNobm9sb2dpZXMiLCJhIjoiY2tpd2k1NXl3MHIwMzMxbzg2czd3dTRsbCJ9.TL0YU0IyEtIZnOYyKhOVQg";
...
const popUp = new mapboxgl.Popup({ closeButton: !1, closeOnClick: !1 });
let interval;
...
function onHover(colo) {
	...
	const description = colo.features[0].properties.description;
	while (Math.abs(colo.lngLat.lng - coords[0]) > 180)
		coords[0] += colo.lngLat.lng > a[0] ? 360 : -360;
